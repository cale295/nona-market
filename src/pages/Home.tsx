  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      if (error) {
        ...
        setAllProducts(data || []);
        setFeaturedProducts((data || []).slice(0, displayCount));
      }
    };
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                {featuredProducts.map((product) => (
                  <div
                    ...
                    className="group bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden hover:-translate-y-2 border border-gray-100 relative"
                  >
                    {/* Product Badge */}
              ...
              <div className="text-center mt-16">
                {hasMoreProducts ? (
                  ...
                  <button className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-2xl font-bold hover:from-indigo-700 hover:to-purple-700 hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center space-x-3 mx-auto shadow-lg group">
