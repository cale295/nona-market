        ...
        <div className="container mx-auto px-4 lg:px-6 text-center relative z-10">
          <div className="flex items-center justify-center mb-6">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white">
              Bergabunglah dengan
              <span className="text-yellow-300 ml-2">10,000+</span>
            </h2>
          </div>
          <h3 className="text-xl md:text-2xl text-white/90 mb-4 font-medium">
            Muslimah Indonesia yang Percaya pada Kami
          </h3>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 rounded-2xl border-0 focus:outline-none focus:ring-4 focus:ring-white/30 text-gray-800 placeholder-gray-500 shadow-lg"
                  />
                </div>
                <button
